...
/*
 * Function:    setting_window_set_timer
 * -------------------------------------
 * sets a CountdownTimer to be associated with this SettingWindow
 *
 *  setting_window: a pointer to the SettingWindow being assigned the timer
...
/*
 * Function:    setting_window_get_timer
 * -------------------------------------
 * gets the CountdownTimer associated with this SettingWindow
 *
 *  setting_window: a pointer to the SettingWindow being checked
 *
 *  returns: a pointer to the CountdownTimer associated with the SettingWindow
 */
