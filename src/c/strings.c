...
// Die Wochentage werden mit STR_WD_SUN + tm_wday adressiert. Stehen sie nicht
// zusammenhaengend, bricht der Build hier statt spaeter falsche Kuerzel zu
// zeigen (negative Arraygroesse).
typedef char strings_weekdays_must_be_contiguous[
  (STR_WD_SAT - STR_WD_SUN == 6) ? 1 : -1];
